...
- SDK
  - API dump layer: Fix build on Windows on ARM64. (Also included in 1.0.28.1 SDK
    hotfix release.)
  ...
  - Android AAR artifacts (loader) and hello_xr: Fix `<queries>` element contents.
    (Also included in 1.0.28.2 SDK hotfix release.)
  ...
  - Android AAR artifacts: Fix C++ standard library selection for Android artifacts
    in `build-aar.sh` (Also included in 1.0.28.2 SDK hotfix release.)
  ...
  - Android AAR artifacts: Use `jar` instead of 7-zip to perform archiving, and
    document requirements in `build-aar.sh` (Also included in 1.0.28.2 SDK hotfix
    release.)
    ([internal MR 2836](https://gitlab.khronos.org/openxr/openxr/merge_requests/2836),
  ...
  - build system: Support SDK hotfix versions (fourth version component). (Also
    included in 1.0.28.2 SDK hotfix release.)
    ([internal MR 2836](https://gitlab.khronos.org/openxr/openxr/merge_requests/2836))
  - layers: Build with `/bigobj` or equivalent on Windows due to increased number
    of generated functions with spec growth.  (Also included in 1.0.28.1 SDK hotfix
    release.)
